...
class PenjualanSparepart extends Model
{
    ...
    {
        return $this->belongsToMany(DetailSparepart::class, 'tb_fo_detail_penjualan_sparepart', 'id_penjualan_sparepart', 'id_detail_sparepart')->withPivot('jumlah', 'total_harga', 'harga');
    }
