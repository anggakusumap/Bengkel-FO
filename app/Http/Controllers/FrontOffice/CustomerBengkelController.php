...
class CustomerBengkelController extends Controller
{
    ...
    public function show($id_customer_bengkel)
    {
        ...
        $service = PenerimaanService::with(['detail_sparepart','detail_perbaikan','kendaraan','bengkel'])->join('tb_fo_customer_bengkel','tb_marketplace_bengkel.id_bengkel','tb_fo_customer_bengkel.id_bengkel')
